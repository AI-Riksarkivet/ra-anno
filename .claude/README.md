...
Skills don't auto-activate reliably without a hook. The forced-eval hook gets
84% activation vs 20% without:
...
Use [claude-skills-cli](https://github.com/spences10/claude-skills-cli) for
