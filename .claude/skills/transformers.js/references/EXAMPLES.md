...
Working examples showing how to use Transformers.js across different runtimes
and frameworks.
  ...
  <body>
    ...
    <script type="module">
      ...
      window.generateEmbedding = async function () {
        ...
        <p>First 5 values: ${
          Array.from(output.data).slice(0, 5).join(", ")
        }</p>
      `;
      };
          ...
          progress_callback: (info) => {
            ...
            if (info.status === "progress") {
              ...
              `;
                ...
                fileProgressBars[info.file] = fileDiv.querySelector(
                  ".progress-fill",
                );
              }

              // Update progress
              fileProgressBars[info.file].style.width =
                `${info.progress}%`;
            }
...
These examples demonstrate the same functionality across different runtimes and
frameworks, making it easy to adapt to your specific use case. All examples
include proper cleanup with `.dispose()` to free memory.
