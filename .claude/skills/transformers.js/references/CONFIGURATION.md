...
**Use case:** Offline applications, security requirements, or air-gapped
environments.
...
**Use case:** Self-hosting models, using a CDN for faster downloads, or
corporate proxies.
...
Transformers.js supports multiple caching strategies to improve performance and
...
- **[Caching Reference](./CACHE.md)** - Comprehensive caching guide (browser,
  Node.js, custom implementations)
- [Pipeline Options](./PIPELINE_OPTIONS.md) - Configure pipeline loading with
