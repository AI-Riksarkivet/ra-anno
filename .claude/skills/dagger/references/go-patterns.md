...
Copy standalone binaries from tool containers into your build. Avoids installing
package managers in the target image:
...
The module provides a native Dagger reimplementation of Docker Compose. Current
compatibility: image, build, ports, environment, entrypoint, command.
