<script lang="ts">
  ...
  const shortcuts = [
    { category: "Tools", items: [
      ...
      { keys: ["7"], action: "Pencil — freehand (edit)" },
      { keys: ["8"], action: "Point (edit)" },
      { keys: ["9"], action: "Line (edit)" },
      { keys: ["B"], action: "Brush — paint mask (edit)" },
    ]},
    { category: "Drawing", items: [
      { keys: ["Shift"], action: "Constrain to square (rect)" },
      { keys: ["Ctrl"], action: "Draw from center (rect)" },
      { keys: ["Shift"], action: "Pencil → open baseline" },
      { keys: ["Backspace"], action: "Remove last vertex (polygon)" },
      { keys: ["Dbl-click"], action: "Close polygon" },
      { keys: ["Alt"], action: "Brush → erase" },
      { keys: ["Enter"], action: "Finish brush mask" },
    ]},
